...
const Provider = z.object({ id: z.string().min(1), env: z.array(z.string().min(1)).min(1), npm: z.string().min(1), api: z.string().optional(), name: z.string().min(1), doc: z.string().min(1), models: z.record(z.string(), Model) }).strict().superRefine((provider, context) => {
