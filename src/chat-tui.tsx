...
import type { McpServerStatus, PermissionMode, SDKMessage } from "@anthropic-ai/claude-agent-sdk";
...
type Screen = "chat" | "models" | "providers" | "usage" | "permissions" | "help" | "theme" | "mcp";
